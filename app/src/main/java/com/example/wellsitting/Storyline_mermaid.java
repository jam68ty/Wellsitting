...
public class Storyline_mermaid extends Fragment {
    ...
    private TextView mermaid_score;
    ...
    private TextView mPrice_5;
    private TextView mPrice_6;
    private TextView mPrice_7;

    Context mcontext;
    FirebaseAuth mAuth;
    Context context;
    private ImageButton mbuy1;
    private ImageButton mbuy2;
    private ImageButton mbuy3;
    private ImageButton mbuy4;
    private ImageButton mbuy5;
    private ImageButton mbuy6;
    private ImageButton mbuy7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_storyline_mermaid, container, false);

        gift=view.findViewById(R.id.gift_dg);
        ...
        mch2=view.findViewById(R.id.mermaidch2);
        mcontext=inflater.getContext();
        mAuth = FirebaseAuth.getInstance();
        mermaid_score=view.findViewById(R.id.mermaid_score);

        mPrice_2=view.findViewById(R.id.mPrice_2);
        mPrice_3=view.findViewById(R.id.mPrice_3);
        mPrice_4=view.findViewById(R.id.mPrice_4);
        mPrice_5=view.findViewById(R.id.mPrice_5);
        mPrice_6=view.findViewById(R.id.mPrice_6);
        mPrice_7=view.findViewById(R.id.mPrice_7);
...
//--------------------------------------------------------------------------------------------
        ...
        DatabaseReference myRef_rch2 = database.getReference("account").child(user.getUid()).child("story_m");
        DatabaseReference myRef_rch3 = database.getReference("account").child(user.getUid()).child("story_m");
        DatabaseReference myRef_rch4 = database.getReference("account").child(user.getUid()).child("story_m");
        DatabaseReference myRef_rch5 = database.getReference("account").child(user.getUid()).child("story_m");
        DatabaseReference myRef_rch6 = database.getReference("account").child(user.getUid()).child("story_m");
        DatabaseReference myRef_rch7 = database.getReference("account").child(user.getUid()).child("story_m");
//-----------------------------------------------------------------------------------------------
        ...
        myRef_rch3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(buyornot!=null && buyornot.equals("true")) {
                    mbuy3.setImageResource(R.drawable.story_mgot);
        ...
        myRef_rch4.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(buyornot!=null && buyornot.equals("true")) {
                    mbuy4.setImageResource(R.drawable.story_mgot);
        ...
        myRef_rch5.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(buyornot!=null && buyornot.equals("true")) {
                    mbuy5.setImageResource(R.drawable.story_mgot);
        ...
        myRef_rch6.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(buyornot!=null && buyornot.equals("true")) {
                    mbuy6.setImageResource(R.drawable.story_mgot);
        ...
        myRef_rch7.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(buyornot!=null && buyornot.equals("true")) {
                    mbuy7.setImageResource(R.drawable.story_mgot);
...
//-----------------------------------------------------------------------------------------------
        ...
        mbuy1=view.findViewById(R.id.mbuy_1);
        mbuy2=view.findViewById(R.id.mbuy_2);
        mbuy3=view.findViewById(R.id.mbuy_3);
        mbuy4=view.findViewById(R.id.mbuy_4);
        mbuy5=view.findViewById(R.id.mbuy_5);
        mbuy6=view.findViewById(R.id.mbuy_6);
        mbuy7=view.findViewById(R.id.mbuy_7);


        mch1=view.findViewById(R.id.mermaidch1);
        mch2=view.findViewById(R.id.mermaidch2);
        mch3=view.findViewById(R.id.mermaidch3);
        mch4=view.findViewById(R.id.mermaidch4);
        mch5=view.findViewById(R.id.mermaidch5);
        mch6=view.findViewById(R.id.mermaidch6);
        mch7=view.findViewById(R.id.mermaidch7);
        ...
        mch1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor ch1 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                ch1.putInt("CH",1);
                ch1.apply();
        ...
        mch2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String s=mPrice_2.getText().toString().substring(0);
                if(s.equals("")){
                    SharedPreferences.Editor line = getActivity().getSharedPreferences("LINE", MODE_PRIVATE).edit();
                    line.putString("LINE", "MERMAID");
                    line.apply();

                    SharedPreferences.Editor ch2 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                    ch2.putInt("CH",2);
                    ch2.apply();
        ...
        mch3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String s=mPrice_3.getText().toString().substring(0);
                if(s.equals("")){
                    SharedPreferences.Editor line = getActivity().getSharedPreferences("LINE", MODE_PRIVATE).edit();
                    line.putString("LINE", "MERMAID");
                    line.apply();

                    SharedPreferences.Editor ch3 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                    ch3.putInt("CH",3);
                    ch3.apply();
        ...
        mch4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String s=mPrice_4.getText().toString().substring(0);
                if(s.equals("")){
                    SharedPreferences.Editor line = getActivity().getSharedPreferences("LINE", MODE_PRIVATE).edit();
                    line.putString("LINE", "MERMAID");
                    line.apply();

                    SharedPreferences.Editor ch4 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                    ch4.putInt("CH",4);
                    ch4.apply();
        ...
        mch5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String s=mPrice_5.getText().toString().substring(0);
                if(s.equals("")){
                    SharedPreferences.Editor line = getActivity().getSharedPreferences("LINE", MODE_PRIVATE).edit();
                    line.putString("LINE", "MERMAID");
                    line.apply();

                    SharedPreferences.Editor ch5 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                    ch5.putInt("CH",5);
                    ch5.apply();
        ...
        mch6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String s=mPrice_6.getText().toString().substring(0);
                if(s.equals("")){
                    SharedPreferences.Editor line = getActivity().getSharedPreferences("LINE", MODE_PRIVATE).edit();
                    line.putString("LINE", "MERMAID");
                    line.apply();

                    SharedPreferences.Editor ch6 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                    ch6.putInt("CH",6);
                    ch6.apply();
        ...
        mch7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String s=mPrice_7.getText().toString().substring(0);
                if(s.equals("")){
                    SharedPreferences.Editor line = getActivity().getSharedPreferences("LINE", MODE_PRIVATE).edit();
                    line.putString("LINE", "MERMAID");
                    line.apply();

                    SharedPreferences.Editor ch7 = getActivity().getSharedPreferences("MERMAID", MODE_PRIVATE).edit();
                    ch7.putInt("CH",7);
                    ch7.apply();
        ...
        mbuy1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
        ...
        mbuy2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                String i=String.valueOf(mermaid_score.getText());
                String s=mPrice_2.getText().toString().substring(0);
        ...
        mbuy3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                String i=String.valueOf(mermaid_score.getText());
                String s=mPrice_3.getText().toString().substring(0);
                int t =Integer.parseInt(i.trim());
        ...
        mbuy4.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                String i=String.valueOf(mermaid_score.getText());
                String s=mPrice_4.getText().toString().substring(0);
                int t =Integer.parseInt(i.trim());
        ...
        mbuy5.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                String i=String.valueOf(mermaid_score.getText());
                String s=mPrice_5.getText().toString().substring(0);
                int t =Integer.parseInt(i.trim());
        ...
        mbuy6.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                String i=String.valueOf(mermaid_score.getText());
                String s=mPrice_6.getText().toString().substring(0);
                int t =Integer.parseInt(i.trim());
        ...
        mbuy7.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                String i=String.valueOf(mermaid_score.getText());
                String s=mPrice_7.getText().toString().substring(0);
                int t =Integer.parseInt(i.trim());
